...
sns.heatmap(confusion_matrix(y_test, y_pred_svm), annot = True, linewidths=.5, cmap="viridis")
plt.title('Corelation Between Features')
plt.show()
plt.savefig('/Users/kao900531/Desktop/DataMining/SVM_heatmap.png')

print('True Positive Cases : {}'.format(confusion_matrix(y_test, y_pred_svm)[1][1]))
print('True Negative Cases : {}'.format(confusion_matrix(y_test, y_pred_svm)[0][0]))
print('False Positive Cases : {}'.format(confusion_matrix(y_test, y_pred_svm)[0][1]))
print('False Negative Cases : {}'.format(confusion_matrix(y_test, y_pred_svm)[1][0]))
